...
export function parseBrokerPdfText(text: string, source: string): PortfolioParseResult {
  ...
  if (!transactions.length) warnings.push("No compatible transaction rows were found in this PDF. A CSV, QFX/OFX, QIF, or Equity Lab JSON export will be more reliable.");
